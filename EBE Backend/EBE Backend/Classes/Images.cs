...
namespace EBE_Backend.Classes
{
    class Images
    {
        ...
        public void Create( )
        {
            ...
            try
            {
                cmd.CommandText = "INSERT INTO EventsImages (idImage, idEvents, imageAddress) VALUES ( '" + this.id + "', '" + this.eventId + "', '" + this.url + "');";
                cmd.ExecuteNonQuery();
        ...
        public void Update()
        {
            ...
            try
            {
                cmd.CommandText = "update EventsImages set idEvents= '" + this.eventId + "', imageAddress = '" + this.url + "' where id =" + this.id + ";";
                cmd.ExecuteNonQuery();
        ...
        public void Delete( )
        {
            ...
            try
            {
                cmd.CommandText = "delete from EventsImages where Id = " + this.id + ";";
                cmd.ExecuteNonQuery();
